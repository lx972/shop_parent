...
import cn.lx.shop.goods.pojo.Pref;
import cn.lx.shop.goods.service.PrefService;
...
public class PrefController {
    ...
    public PageResult<Pref> findPage(@RequestBody(required = false) @ApiParam(name = "Pref对象",value = "传入JSON数据",required = false) Pref pref, @PathVariable  int page, @PathVariable  int size){
    ...
    public PageResult<Pref> findPage(@PathVariable  int page, @PathVariable  int size){
