...
import cn.lx.shop.goods.pojo.Album;
import cn.lx.shop.goods.service.AlbumService;
...
public class AlbumController {
    ...
    public PageResult<Album> findPage(@RequestBody(required = false) @ApiParam(name = "Album对象",value = "传入JSON数据",required = false) Album album, @PathVariable  int page, @PathVariable  int size){
    ...
    public PageResult<Album> findPage(@PathVariable  int page, @PathVariable  int size){
