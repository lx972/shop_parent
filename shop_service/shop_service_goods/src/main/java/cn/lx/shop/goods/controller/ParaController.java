...
public class ParaController {
    ...
    public PageResult<Para> findPage(@RequestBody(required = false) @ApiParam(name = "Para对象",value = "传入JSON数据",required = false) Para para, @PathVariable  int page, @PathVariable  int size){
    ...
    public PageResult<Para> findPage(@PathVariable  int page, @PathVariable  int size){
