...
import cn.lx.shop.goods.service.CategoryService;
...
public class CategoryController {
    ...
    public PageResult<Category> findPage(@RequestBody(required = false) @ApiParam(name = "Category对象",value = "传入JSON数据",required = false) Category category, @PathVariable  int page, @PathVariable  int size){
    ...
    public PageResult<Category> findPage(@PathVariable  int page, @PathVariable  int size){
