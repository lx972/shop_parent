...
import cn.lx.shop.goods.service.SkuService;
...
public class SkuController {
    ...
    public PageResult<Sku> findPage(@RequestBody(required = false) @ApiParam(name = "Sku对象",value = "传入JSON数据",required = false) Sku sku, @PathVariable  int page, @PathVariable  int size){
    ...
    public PageResult<Sku> findPage(@PathVariable  int page, @PathVariable  int size){
