...
public class SpecController {
    ...
    public PageResult<Spec> findPage(@RequestBody(required = false) @ApiParam(name = "Spec对象",value = "传入JSON数据",required = false) Spec spec, @PathVariable  int page, @PathVariable  int size){
    ...
    public PageResult<Spec> findPage(@PathVariable  int page, @PathVariable  int size){
