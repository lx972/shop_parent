...
public class BrandController {
    ...
    public PageResult<Brand> findPage(@RequestBody(required = false) @ApiParam(name = "Brand对象",value = "传入JSON数据",required = false) Brand brand, @PathVariable  int page, @PathVariable  int size){
    ...
    public PageResult<Brand> findPage(@PathVariable  int page, @PathVariable  int size){
    ...
    public Result<List<Brand>> findByCategoryId(@PathVariable("id") Integer id){
        List<Brand> list = brandService.findByCategoryId(id);
        return new Result<List<Brand>>(true, StatusCode.OK,"查询成功",list) ;
    }
}
