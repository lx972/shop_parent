...
import cn.lx.shop.goods.pojo.CategoryBrand;
import cn.lx.shop.goods.service.CategoryBrandService;
...
public class CategoryBrandController {
    ...
    public PageResult<CategoryBrand> findPage(@RequestBody(required = false) @ApiParam(name = "CategoryBrand对象",value = "传入JSON数据",required = false) CategoryBrand categoryBrand, @PathVariable  int page, @PathVariable  int size){
    ...
    public PageResult<CategoryBrand> findPage(@PathVariable  int page, @PathVariable  int size){
