...
import cn.lx.shop.content.pojo.ContentCategory;
import cn.lx.shop.content.service.ContentCategoryService;
...
public class ContentCategoryController {
    ...
    public PageResult<ContentCategory> findPage(@RequestBody(required = false) @ApiParam(name = "ContentCategory对象",value = "传入JSON数据",required = false) ContentCategory contentCategory, @PathVariable  int page, @PathVariable  int size){
    ...
    public PageResult<ContentCategory> findPage(@PathVariable  int page, @PathVariable  int size){
