...
import cn.lx.shop.order.pojo.CategoryReport;
import cn.lx.shop.order.service.CategoryReportService;
...
public class CategoryReportController {
    ...
    public PageResult<CategoryReport> findPage(@RequestBody(required = false) @ApiParam(name = "CategoryReport对象",value = "传入JSON数据",required = false) CategoryReport categoryReport, @PathVariable  int page, @PathVariable  int size){
        ...
        return new PageResult<CategoryReport>(pageInfo.getTotal(),pageInfo.getList());
    }
    ...
    public PageResult<CategoryReport> findPage(@PathVariable  int page, @PathVariable  int size){
