...
import cn.lx.shop.order.pojo.Preferential;
import cn.lx.shop.order.service.PreferentialService;
...
public class PreferentialController {
    ...
    public PageResult<Preferential> findPage(@RequestBody(required = false) @ApiParam(name = "Preferential对象",value = "传入JSON数据",required = false) Preferential preferential, @PathVariable  int page, @PathVariable  int size){
        ...
        return new PageResult<Preferential>(pageInfo.getTotal(),pageInfo.getList());
    }
    ...
    public PageResult<Preferential> findPage(@PathVariable  int page, @PathVariable  int size){
