...
public class OrderController {
    ...
    public PageResult<Order> findPage(@RequestBody(required = false) @ApiParam(name = "Order对象",value = "传入JSON数据",required = false) Order order, @PathVariable  int page, @PathVariable  int size){
    ...
    public PageResult<Order> findPage(@PathVariable  int page, @PathVariable  int size){
