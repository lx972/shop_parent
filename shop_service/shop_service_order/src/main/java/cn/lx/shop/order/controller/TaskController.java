...
import cn.lx.shop.order.pojo.Task;
import cn.lx.shop.order.service.TaskService;
...
public class TaskController {
    ...
    public PageResult<Task> findPage(@RequestBody(required = false) @ApiParam(name = "Task对象",value = "传入JSON数据",required = false) Task task, @PathVariable  int page, @PathVariable  int size){
    ...
    public PageResult<Task> findPage(@PathVariable  int page, @PathVariable  int size){
