...
import cn.lx.shop.order.pojo.ReturnOrderItem;
import cn.lx.shop.order.service.ReturnOrderItemService;
...
public class ReturnOrderItemController {
    ...
    public PageResult<ReturnOrderItem> findPage(@RequestBody(required = false) @ApiParam(name = "ReturnOrderItem对象",value = "传入JSON数据",required = false) ReturnOrderItem returnOrderItem, @PathVariable  int page, @PathVariable  int size){
        ...
        return new PageResult<ReturnOrderItem>(pageInfo.getTotal(),pageInfo.getList());
    }
    ...
    public PageResult<ReturnOrderItem> findPage(@PathVariable  int page, @PathVariable  int size){
