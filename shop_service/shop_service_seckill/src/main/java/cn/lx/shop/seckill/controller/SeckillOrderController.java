...
public class SeckillOrderController {
    ...
    public PageResult<SeckillOrder> findPage(@RequestBody(required = false) @ApiParam(name = "SeckillOrder对象",value = "传入JSON数据",required = false) SeckillOrder seckillOrder, @PathVariable  int page, @PathVariable  int size){
        ...
        return new PageResult<SeckillOrder>(pageInfo.getTotal(),pageInfo.getList());
    }
    ...
    public PageResult<SeckillOrder> findPage(@PathVariable  int page, @PathVariable  int size){
