...
import cn.lx.shop.user.pojo.OauthClientDetails;
import cn.lx.shop.user.service.OauthClientDetailsService;
...
public class OauthClientDetailsController {
    ...
    public PageResult<OauthClientDetails> findPage(@RequestBody(required = false) @ApiParam(name = "OauthClientDetails对象",value = "传入JSON数据",required = false) OauthClientDetails oauthClientDetails, @PathVariable  int page, @PathVariable  int size){
        ...
        return new PageResult<OauthClientDetails>(pageInfo.getTotal(),pageInfo.getList());
    }
    ...
    public PageResult<OauthClientDetails> findPage(@PathVariable  int page, @PathVariable  int size){
